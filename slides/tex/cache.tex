...
\begin{frame}\frametitle{Contexte}
  ...
  \begin{block}{Etat de l'art sur les caches en IoT}
    \begin{itemize}
      ...
      \item Cache répartis au niveau des noeuds
    \end{itemize}
  \end{block}
...
\begin{frame}\frametitle{Contribution}
  ...
  \begin{block}{Contraintes}
    \begin{itemize}
      \item Les noeuds veulent répondre au moins de requêtes possibles
  ...
  \begin{alertblock}{Modèle de résolution}
    \begin{itemize}
      \item Fournir les temps de validité optimaux pour les ressources en cache afin d'avoir le meilleur temps de validité possible
      \item Utilisation d'algorithme génétique (NSGA-II) pour la résolution d'un problème multi-objectifs (Satisfaction ou Durée de vie)
    \end{itemize}
  \end{alertblock}
...
\begin{frame}{Architecture de RPCA}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/schema_rpca_slides.pdf}
  \end{figure}
\end{frame}
...
\begin{frame}{Consommation des noeuds serveurs}

  \begin{alertblock}{Consommation des noeuds serveurs}
    \begin{align}
...
\begin{frame}{Consommation des noeuds routeurs}
  \begin{figure}
    \centering
...
\begin{frame}{Validation expérimentale}
  \begin{block}{Condition de trafic}
    \begin{itemize}
      \item Trafic poissonien en entrée
      \item Traduction HTTP / CoAP
    \end{itemize}
  \end{block}

  \begin{block}{Résolution multi-objective}
    \begin{itemize}
      \item Configuration NSGA-II par défaut
      \item Executé en offline puis déployée
    \end{itemize}
  \end{block}
...
\begin{frame}\frametitle{Front de Pareto}

  \begin{figure}[tb]
    \centering
    \includegraphics[width=\textwidth]{../img/pareto.pdf}
  \end{figure}
...
\begin{frame}{Cache hit ratio}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=.75\textwidth]{figures/new_cachinghit.pdf}
  \end{figure}
...
\begin{frame}\frametitle{Résultats: Durée de vie}
  ...
  \begin{block}{Définition}
    Le réseau est considéré comme mort au premier noeud mort.
  \end{block}
